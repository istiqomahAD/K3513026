...
<Table class="table table-striped">
    ...
    <tr>
        ...
        <td><a href="<?php echo site_url('buku/edit/'.$row->kode_buku);?>"><i class="glyphicon glyphicon-edit"></i></a>
        <a href="#" class="hapus" kode_buku="<?php echo $row->kode_buku;?>"><i class="glyphicon glyphicon-trash"></i></a>
		 <a href="<?php echo site_url('buku/detail/'.$row->kode_buku);?>" class="detail"><i class="glyphicon glyphicon-book"></i></a></td>
    </tr>
    <?php endforeach;?>
</Table>
<?php echo $pagination;?>
